...
// Depth 500
void SimpleLog_install(int lvl);

// Depth 500
void SimpleLog_log_MINUS_(LogRecord* r);
...
void SimpleLog_install(int lvl) {
    ...
    Lambda _9 = { .callback = (void*)SimpleLog_log_MINUS_, .env = NULL, .delete = NULL, .copy = NULL }; //Sym SimpleLog.log- (LookupGlobal CarpLand AFunction)
    Log_set_MINUS_logger(_9);
}

void SimpleLog_log_MINUS_(LogRecord* r) {
    int* _9 = LogRecord_level(r);
    int _10 = Int_copy(_9);
    bool _12 = Int__LT_(_10, Log_INFO);
    if (_12) {
        String _18 = LogRecord_pretty(r);
        String* _19 = &_18; // ref
        IO_errorln(_19);
        String_delete(_18);
    } else {
        String _27 = LogRecord_pretty(r);
        String* _28 = &_27; // ref
        IO_println(_28);
        String_delete(_27);
    }
